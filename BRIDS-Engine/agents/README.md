...
| [`pitch-deck-architect`](pitch-deck-architect.md) | YC & Sequoia Pitch Deck Architect | 10-12 slide YC/Sequoia narrative decks, automated native `.pptx` generation via `python-pptx`, slide scripts. | `BRIDS-Brain/02 Strategy & Research/pitch-decks/`, `BRIDS-Engine/outputs/decks/` |
