...
If `BRIDS-Engine/context/product-marketing-context.md` exists, read it before asking questions. Use that context and only ask for information not already covered.

When saving a deliverable, write the final Markdown to `BRIDS-Brain/07 Paid, Social & Community/Community Marketing`.
