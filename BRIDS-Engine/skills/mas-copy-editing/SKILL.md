...
If `BRIDS-Engine/context/product-marketing-context.md` exists, read it before editing. Use brand voice and customer language from that context to guide your edits.

When delivering an edited version as a file, save it as Markdown under `BRIDS-Engine/outputs/`.
