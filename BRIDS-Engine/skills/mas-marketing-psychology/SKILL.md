...
If `BRIDS-Engine/context/product-marketing-context.md` exists, read it before applying mental models. Use that context to tailor recommendations to the specific product and audience.

When saving a deliverable, write the final Markdown to `BRIDS-Brain/02 Strategy & Research/Marketing Psychology`.
