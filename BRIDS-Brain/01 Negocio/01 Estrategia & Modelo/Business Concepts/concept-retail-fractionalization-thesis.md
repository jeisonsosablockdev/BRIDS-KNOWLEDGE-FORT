...
```mermaid
graph TD
    subgraph Tradicional["Modelo Tradicional Excluyente"]
        T1["Ticket Mínimo: $50,000 – $100,000 USD"]
        T2["Papeleo notarial físico y cuenta bancaria en EE.UU."]
        T3["Cero liquidez por 5 a 10 años"]
        T4["Acceso solo para el 1% más rico"]
    end
    ...
    Tradicional -.->|Disrupción Tecnológica| BRIDS
```
