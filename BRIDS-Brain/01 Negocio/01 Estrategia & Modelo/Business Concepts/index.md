...
| **C6** | **Tesis de Democratización y Fraccionamiento Retail ($200 USD)** | [[concept-retail-fractionalization-thesis\|concept-retail-fractionalization-thesis.md]] | `founder-ghostwriter`, `pitch-deck-architect` | Invierte en bienes raíces en Estados Unidos desde $200 USD y recibe rentas en dólares con respaldo legal en el mundo real. |
