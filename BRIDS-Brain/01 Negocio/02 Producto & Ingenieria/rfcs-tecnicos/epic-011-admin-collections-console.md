...
source_okf: "knowledge/rfcs/EPIC-011-admin-collections-console/README.md"
source_commit: "6a40b30"
source_commit_date: "2026-08-22 12:42:13 -0500"
source_hash: "da56fed10b869130e0e59b0ccb7bfb76d67c5c95a2d1918d08fd0264b5af2bc1"
tags: [rfc, epic, epic-011, solana, architecture]
updated_at: "2026-09-12T02:07:49.394Z"
---

# RFC EPIC-011: Consola Administrativa de Colecciones y Proyectos

> [!NOTE]
> **Resumen Técnico:** Panel administrativo con geolocalización Maps, editor de galería y revisión de salud.
...
| --- | --- | --- | --- | --- | --- |
| STORY-011-01 | Kickoff and contract definition | `STORY-011-01-kickoff.md` | `implemented` | `#127` | Define ownership, edit boundaries, and data contract |
| STORY-011-02 | Admin collections read model | `STORY-011-02-admin-collections-read-model.md` | `implemented` | `#129`, `#131`, `#132` | Build listing/query layer for owned marketplace entries; `BRI-80`, `BRI-81`, and `BRI-82` are implemented and the visual refinement moved into `STORY-011-05` |
| STORY-011-03 | Editable collection content persistence | `STORY-011-03-editable-collection-content-persistence.md` | `implemented` | `#133`, `#134`, `#135`, `#136`, `#137` | Persist gallery/property/docs content outside on-chain cover; `BRI-83` adds schema, `BRI-84` closes the mapper contract, `BRI-85` adds the dry-run runner, `BRI-86` adds repository read/write helpers, and `BRI-87` closes edit-session upload lifecycle + cleanup |
| STORY-011-04 | Collections API and ownership enforcement | `STORY-011-04-collections-api-and-ownership-enforcement.md` | `implemented` | `#138`, `#139`, `#140`, `#141` | Add GET/PATCH admin APIs with immutable cover constraints; `BRI-88` adds the centralized ownership helper, `BRI-89` adds detail GET, `BRI-90` adds PATCH payload validation, and `BRI-91` adds the unified PATCH route |
| STORY-011-05 | Collections index UI | `STORY-011-05-collections-index-ui.md` | `implemented` | `#143`, `#144`, `#145` | Replace placeholder with visual admin listing; `BRI-92` adds polished empty/loading/error states, `BRI-93` adds collection cards UI, and `BRI-94` activates the detail handoff route |
...
| 2026-04-26 | STORY-011-08 | El primer slice (`BRI-104`) fija el payload read-only `blockchain.baseAddresses` para collection, candy machine y asset mint con fallback seguro desde snapshot/ownership | jaymusicmachine | `STORY-011-08-blockchain-readonly-panel.md` |
| 2026-04-27 | STORY-011-08 | El segundo slice (`BRI-105`) agrega `third_party_signer`, `freeze_delegate`, `transfer_delegate` y `appdata_authority` al bloque read-only usando `authority_registry`, snapshot y configuracion server-side | jaymusicmachine | `STORY-011-08-blockchain-readonly-panel.md` |
| 2026-04-27 | STORY-011-08 | El tercer slice (`BRI-106`) agrega `startDate`, `tokenPayment.mint` y `tokenPayment.destination` al bloque read-only usando snapshot y fallback canonico de Candy Guard USDC | jaymusicmachine | `STORY-011-08-blockchain-readonly-panel.md` |
| 2026-04-27 | STORY-011-08 | El cuarto slice (`BRI-107`) agrega `blockchain.appdata` reutilizando el contrato canonico `validateAppDataEconomicV1` y degradando a `null` cuando el snapshot no trae payload valido | jaymusicmachine | `STORY-011-08-blockchain-readonly-panel.md` |
| 2026-04-27 | STORY-011-08 | El quinto slice (`BRI-108`) convierte el bloque blockchain minimo en un panel read-only dedicado con base addresses, authorities, guard fields y AppData visibles, manteniendo separacion clara frente a las secciones editables | jaymusicmachine | `STORY-011-08-blockchain-readonly-panel.md` |
| 2026-04-27 | STORY-011-08 | El sexto slice (`BRI-109`) agrega copy-to-clipboard y enlaces externos a Solscan mediante un client component acotado, junto con una prueba DOM focalizada soportada por `jsdom` | jaymusicmachine | `STORY-011-08-blockchain-readonly-panel.md` |
...
| 2026-04-26 | STORY-011-07 | El segundo slice (`BRI-101`) agrega el Playwright flow determinista de `/admin/collections` con auth admin real, fixture server-side de lectura y verificación de summary/property/documents + cover read-only | jaymusicmachine | `STORY-011-07-qa-responsive-evidence-and-docs-sync.md` |
| 2026-04-26 | STORY-011-07 | El tercer slice (`BRI-103`) agrega el responsive QA evidence pack del módulo admin collections para index/detail en `320`, `375`, `768` y `1024`, incluyendo checklist JSON y screenshots por breakpoint | jaymusicmachine | `STORY-011-07-qa-responsive-evidence-and-docs-sync.md` |
| 2026-04-26 | STORY-011-07 | El cuarto slice (`BRI-102`) cierra el sync documental y la trazabilidad RFC del story, dejándolo `implemented` en la rama de integración y listo para PR final a `develop` tras revisión de usuario | jaymusicmachine | `STORY-011-07-qa-responsive-evidence-and-docs-sync.md` |
...
|---|---|---|---|
| 2026-09-12 | v1.0.0 | sync-technical-docs (`6a40b30`) | Sincronización e ingesta canónica desde knowledge/rfcs/EPIC-011-admin-collections-console/README.md |
