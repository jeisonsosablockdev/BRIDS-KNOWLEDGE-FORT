...
target_file: "BRIDS-Brain/01 Negocio/04 Finanzas & YC Investors/yc-application/yc-application-master-template-2025.md"
subagents_involved:
  - "founder-ghostwriter"
  - "business-consultant"
...
# Spec: YC Application Master Template 2025 — Cuestionario Oficial y Requisitos BRIDS

> [!NOTE]
> **Resumen Ejecutivo:** Consolidar el cuestionario maestro y checklist de requisitos de YC 2025 para BRIDS basado en la guia oficial de Leland, integrando las anclas tecnicas de Solana, unit economics y borrador de respuestas.
...
- **Carpeta de Destino:** `BRIDS-Brain/01 Negocio/04 Finanzas & YC Investors/yc-application/`
- **Archivo de Salida:** `BRIDS-Brain/01 Negocio/04 Finanzas & YC Investors/yc-application/yc-application-master-template-2025.md`
...
| :--- | :--- | :--- |
| `founder-ghostwriter` | Creador / Editor Líder | Redacción inicial del borrador técnico/estratégico y subsanación activa de observaciones. |
...
- **Objetivo de Negocio:** Consolidar el cuestionario maestro y checklist de requisitos de YC 2025 para BRIDS basado en la guia oficial de Leland, integrando las anclas tecnicas de Solana, unit economics y borrador de respuestas.
- **Público Objetivo (ICP):** Y Combinator Partners & Real Estate LPs
...
- [x] **STEP-01 (HITL-1 Spec Review & Approval):** Inspección humana del spec (`sdd-manager.sh preview yc-application-master-template-2025`), refinamiento opcional con `refine-spec` y aprobación formal mediante `bash BRIDS-Engine/scripts/sdd-manager.sh approve-spec yc-application-master-template-2025`.
- [x] **STEP-02 (Initial Draft Generation):** Redacción inicial del borrador por `founder-ghostwriter` respetando el outline y las anclas técnicas.
...
- [x] **STEP-04 (HITL-2 Deliverable Review & Approval):** Inspección humana del texto pulido (`sdd-manager.sh review-deliverable yc-application-master-template-2025`), ajustes con `refine-deliverable` y aprobación formal mediante `bash BRIDS-Engine/scripts/sdd-manager.sh approve-deliverable yc-application-master-template-2025`.
- [x] **STEP-05 (Vault Integration):** Promoción atómica e idempotente del documento aceptado a `BRIDS-Brain/01 Negocio/04 Finanzas & YC Investors/yc-application-master-template-2025.md`.
