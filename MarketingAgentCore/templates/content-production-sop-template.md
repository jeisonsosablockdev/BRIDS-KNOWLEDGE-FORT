---
title: "Guía Técnica & Manual de Producción de Contenido (SOP)"
...
```mermaid
graph TD
    A["PASO 1: Pre-producción & Lista de Tomas / Slides"] --> B["PASO 2: Rodaje & Captura de Fotos en Taller"]
    B --> C["PASO 3: Edición de Video / Composición de Carrusel"]
    C --> D["PASO 4: Redacción de Copy Comercial Asertivo (4 Reglas)"]
    D --> E["PASO 5: Publicación, Horario & Programación"]
```
