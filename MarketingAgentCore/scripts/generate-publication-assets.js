...
const BRAND_CONTEXT_PATH = path.join(ROOT_DIR, 'MarketingAgentCore', 'context', 'product-marketing-context.md');
const STYLE_GUIDE_PATH = path.join(ROOT_DIR, 'MarketingAgentCore', 'context', 'brand-visual-style-guide.md');
...
USO:
  bash MarketingAgentCore/scripts/generate-publication-assets.sh <nota-o-slug> [opciones]

EJEMPLOS:
  # Referenciar por nombre de archivo:
  bash MarketingAgentCore/scripts/generate-publication-assets.sh "2026-08-13-instagram-carrusel-hanbok-reinterpretado-concierto-bts.md"

  # Referenciar por slug o palabra clave:
  bash MarketingAgentCore/scripts/generate-publication-assets.sh "hanbok"

  # Referenciar y suministrar la foto de entrada de la prenda:
  bash MarketingAgentCore/scripts/generate-publication-assets.sh "sacerdotisa" --input-image ./foto-prenda.jpg

  # Salida en JSON para automatizaciones / agentes:
  bash MarketingAgentCore/scripts/generate-publication-assets.sh "choso" --json
